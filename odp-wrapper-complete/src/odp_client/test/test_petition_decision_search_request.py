...
class TestPetitionDecisionSearchRequest(unittest.TestCase):
    """PetitionDecisionSearchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PetitionDecisionSearchRequest:
        """Test PetitionDecisionSearchRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PetitionDecisionSearchRequest`
        """
        model = PetitionDecisionSearchRequest()
        if include_optional:
            return PetitionDecisionSearchRequest(
    ...
    def testPetitionDecisionSearchRequest(self):
        """Test PetitionDecisionSearchRequest"""
