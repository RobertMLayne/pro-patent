...
class TestPGPubFileMetaData(unittest.TestCase):
    """PGPubFileMetaData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PGPubFileMetaData:
        """Test PGPubFileMetaData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PGPubFileMetaData`
        """
        model = PGPubFileMetaData()
        if include_optional:
            return PGPubFileMetaData(
    ...
    def testPGPubFileMetaData(self):
        """Test PGPubFileMetaData"""
