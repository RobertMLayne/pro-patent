...
class TestProductFileBagFileDataBagInner(unittest.TestCase):
    """ProductFileBagFileDataBagInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProductFileBagFileDataBagInner:
        """Test ProductFileBagFileDataBagInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProductFileBagFileDataBagInner`
        """
        model = ProductFileBagFileDataBagInner()
        if include_optional:
            return ProductFileBagFileDataBagInner(
    ...
    def testProductFileBagFileDataBagInner(self):
        """Test ProductFileBagFileDataBagInner"""
