...
class TestBulkDataProductBagInner(unittest.TestCase):
    """BulkDataProductBagInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BulkDataProductBagInner:
        """Test BulkDataProductBagInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BulkDataProductBagInner`
        """
        model = BulkDataProductBagInner()
        if include_optional:
            return BulkDataProductBagInner(
    ...
    def testBulkDataProductBagInner(self):
        """Test BulkDataProductBagInner"""
