...
class TestResponse400(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> Response400:
        """Test Response400
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Response400`
        """
        model = Response400()
        if include_optional:
            return Response400(
                code = 400,
                error = Bad Request,
                error_details = Invalid request, review petition decision data request filter section and try again,
