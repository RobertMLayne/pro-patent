...
class TestApiV1PatentApplicationsSearchGet404Response(unittest.TestCase):
    """ApiV1PatentApplicationsSearchGet404Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiV1PatentApplicationsSearchGet404Response:
        """Test ApiV1PatentApplicationsSearchGet404Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiV1PatentApplicationsSearchGet404Response`
        """
        model = ApiV1PatentApplicationsSearchGet404Response()
        if include_optional:
            return ApiV1PatentApplicationsSearchGet404Response(
                code = 404,
                error = Not Found,
                error_details = No matching records found, refine your search criteria and try again,
    ...
    def testApiV1PatentApplicationsSearchGet404Response(self):
        """Test ApiV1PatentApplicationsSearchGet404Response"""
