...
class TestPatentDataResponse(unittest.TestCase):
    """PatentDataResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatentDataResponse:
        """Test PatentDataResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatentDataResponse`
        """
        model = PatentDataResponse()
        if include_optional:
            return PatentDataResponse(
                count = 1,
                patent_file_wrapper_data_bag = [
                    openapi_client.models.patent_data_response_patent_file_wrapper_data_bag_inner.PatentDataResponse_patentFileWrapperDataBag_inner(
                ...
                facets = [
                    openapi_client.models.patent_data_response_facets_inner.PatentDataResponse_facets_inner(
                        application_status_code = [
                            openapi_client.models.patent_data_response_facets_inner_application_status_code_inner.PatentDataResponse_facets_inner_applicationStatusCode_inner(
                                value = 'Utility', 
                                count = 44673, )
                            ], )
                    ]
    ...
    def testPatentDataResponse(self):
        """Test PatentDataResponse"""
