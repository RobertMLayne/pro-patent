...
class TestForeignPriority(unittest.TestCase):
    """ForeignPriority unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ForeignPriority:
        """Test ForeignPriority
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ForeignPriority`
        """
        model = ForeignPriority()
        if include_optional:
