...
class TestApplicationMetaDataEntityStatusData(unittest.TestCase):
    """ApplicationMetaDataEntityStatusData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplicationMetaDataEntityStatusData:
        """Test ApplicationMetaDataEntityStatusData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplicationMetaDataEntityStatusData`
        """
        model = ApplicationMetaDataEntityStatusData()
        if include_optional:
            return ApplicationMetaDataEntityStatusData(
    ...
    def testApplicationMetaDataEntityStatusData(self):
        """Test ApplicationMetaDataEntityStatusData"""
