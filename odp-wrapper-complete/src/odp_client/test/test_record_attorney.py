...
class TestRecordAttorney(unittest.TestCase):
    """RecordAttorney unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RecordAttorney:
        """Test RecordAttorney
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RecordAttorney`
        """
        model = RecordAttorney()
        if include_optional:
