...
class TestFacetsProductLabelArrayTextInner(unittest.TestCase):
    """FacetsProductLabelArrayTextInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FacetsProductLabelArrayTextInner:
        """Test FacetsProductLabelArrayTextInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FacetsProductLabelArrayTextInner`
        """
        model = FacetsProductLabelArrayTextInner()
        if include_optional:
            return FacetsProductLabelArrayTextInner(
                value = 'PATENT',
                count = 1
            )
        else:
    ...
    def testFacetsProductLabelArrayTextInner(self):
        """Test FacetsProductLabelArrayTextInner"""
