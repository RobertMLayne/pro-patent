...
class TestApplicationMetaDataApplicantBagInner(unittest.TestCase):
    """ApplicationMetaDataApplicantBagInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplicationMetaDataApplicantBagInner:
        """Test ApplicationMetaDataApplicantBagInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplicationMetaDataApplicantBagInner`
        """
        model = ApplicationMetaDataApplicantBagInner()
        if include_optional:
            return ApplicationMetaDataApplicantBagInner(
    ...
    def testApplicationMetaDataApplicantBagInner(self):
        """Test ApplicationMetaDataApplicantBagInner"""
