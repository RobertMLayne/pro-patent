...
class TestGrantFileMetaData(unittest.TestCase):
    """GrantFileMetaData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GrantFileMetaData:
        """Test GrantFileMetaData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GrantFileMetaData`
        """
        model = GrantFileMetaData()
        if include_optional:
            return GrantFileMetaData(
    ...
    def testGrantFileMetaData(self):
        """Test GrantFileMetaData"""
