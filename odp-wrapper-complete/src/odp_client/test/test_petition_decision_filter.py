...
class TestPetitionDecisionFilter(unittest.TestCase):
    """PetitionDecisionFilter unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PetitionDecisionFilter:
        """Test PetitionDecisionFilter
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PetitionDecisionFilter`
        """
        model = PetitionDecisionFilter()
        if include_optional:
            return PetitionDecisionFilter(
    ...
    def testPetitionDecisionFilter(self):
        """Test PetitionDecisionFilter"""
