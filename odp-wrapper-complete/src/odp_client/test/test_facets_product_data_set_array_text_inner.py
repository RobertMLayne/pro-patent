...
class TestFacetsProductDataSetArrayTextInner(unittest.TestCase):
    """FacetsProductDataSetArrayTextInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FacetsProductDataSetArrayTextInner:
        """Test FacetsProductDataSetArrayTextInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FacetsProductDataSetArrayTextInner`
        """
        model = FacetsProductDataSetArrayTextInner()
        if include_optional:
            return FacetsProductDataSetArrayTextInner(
                value = 'Research',
                count = 1
            )
        else:
    ...
    def testFacetsProductDataSetArrayTextInner(self):
        """Test FacetsProductDataSetArrayTextInner"""
