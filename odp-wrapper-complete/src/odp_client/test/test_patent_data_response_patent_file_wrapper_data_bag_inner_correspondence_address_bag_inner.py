...
class TestPatentDataResponsePatentFileWrapperDataBagInnerCorrespondenceAddressBagInner(unittest.TestCase):
    """PatentDataResponsePatentFileWrapperDataBagInnerCorrespondenceAddressBagInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatentDataResponsePatentFileWrapperDataBagInnerCorrespondenceAddressBagInner:
        """Test PatentDataResponsePatentFileWrapperDataBagInnerCorrespondenceAddressBagInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatentDataResponsePatentFileWrapperDataBagInnerCorrespondenceAddressBagInner`
        """
        model = PatentDataResponsePatentFileWrapperDataBagInnerCorrespondenceAddressBagInner()
        if include_optional:
            return PatentDataResponsePatentFileWrapperDataBagInnerCorrespondenceAddressBagInner(
    ...
    def testPatentDataResponsePatentFileWrapperDataBagInnerCorrespondenceAddressBagInner(self):
        """Test PatentDataResponsePatentFileWrapperDataBagInnerCorrespondenceAddressBagInner"""
