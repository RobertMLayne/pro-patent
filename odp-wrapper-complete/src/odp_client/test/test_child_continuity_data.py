...
class TestChildContinuityData(unittest.TestCase):
    """ChildContinuityData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChildContinuityData:
        """Test ChildContinuityData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChildContinuityData`
        """
        model = ChildContinuityData()
        if include_optional:
            return ChildContinuityData(
    ...
    def testChildContinuityData(self):
        """Test ChildContinuityData"""
