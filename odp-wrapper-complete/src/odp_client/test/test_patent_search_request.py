...
class TestPatentSearchRequest(unittest.TestCase):
    """PatentSearchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatentSearchRequest:
        """Test PatentSearchRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatentSearchRequest`
        """
        model = PatentSearchRequest()
        if include_optional:
    ...
    def testPatentSearchRequest(self):
        """Test PatentSearchRequest"""
