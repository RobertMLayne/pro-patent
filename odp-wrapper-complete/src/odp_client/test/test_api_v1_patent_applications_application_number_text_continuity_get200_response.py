...
class TestApiV1PatentApplicationsApplicationNumberTextContinuityGet200Response(unittest.TestCase):
    """ApiV1PatentApplicationsApplicationNumberTextContinuityGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiV1PatentApplicationsApplicationNumberTextContinuityGet200Response:
        """Test ApiV1PatentApplicationsApplicationNumberTextContinuityGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiV1PatentApplicationsApplicationNumberTextContinuityGet200Response`
        """
        model = ApiV1PatentApplicationsApplicationNumberTextContinuityGet200Response()
        if include_optional:
            return ApiV1PatentApplicationsApplicationNumberTextContinuityGet200Response(
                count = 1,
                patent_file_wrapper_data_bag = [
                    openapi_client.models._api_v1_patent_applications__application_number_text__continuity_get_200_response_patent_file_wrapper_data_bag_inner._api_v1_patent_applications__applicationNumberText__continuity_get_200_response_patentFileWrapperDataBag_inner(
    ...
    def testApiV1PatentApplicationsApplicationNumberTextContinuityGet200Response(self):
        """Test ApiV1PatentApplicationsApplicationNumberTextContinuityGet200Response"""
