...
class TestDocumentBagDocumentBagInnerDownloadOptionBagInner(unittest.TestCase):
    """DocumentBagDocumentBagInnerDownloadOptionBagInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentBagDocumentBagInnerDownloadOptionBagInner:
        """Test DocumentBagDocumentBagInnerDownloadOptionBagInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentBagDocumentBagInnerDownloadOptionBagInner`
        """
        model = DocumentBagDocumentBagInnerDownloadOptionBagInner()
        if include_optional:
            return DocumentBagDocumentBagInnerDownloadOptionBagInner(
    ...
    def testDocumentBagDocumentBagInnerDownloadOptionBagInner(self):
        """Test DocumentBagDocumentBagInnerDownloadOptionBagInner"""
