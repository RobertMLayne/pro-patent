...
class TestAssignmentAssigneeBagInner(unittest.TestCase):
    """AssignmentAssigneeBagInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssignmentAssigneeBagInner:
        """Test AssignmentAssigneeBagInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssignmentAssigneeBagInner`
        """
        model = AssignmentAssigneeBagInner()
        if include_optional:
            return AssignmentAssigneeBagInner(
    ...
    def testAssignmentAssigneeBagInner(self):
        """Test AssignmentAssigneeBagInner"""
