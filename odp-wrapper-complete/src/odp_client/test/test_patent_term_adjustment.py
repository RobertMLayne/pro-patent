...
class TestPatentTermAdjustment(unittest.TestCase):
    """PatentTermAdjustment unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatentTermAdjustment:
        """Test PatentTermAdjustment
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatentTermAdjustment`
        """
        model = PatentTermAdjustment()
        if include_optional:
            return PatentTermAdjustment(
                a_delay_quantity = 0,
    ...
    def testPatentTermAdjustment(self):
        """Test PatentTermAdjustment"""
