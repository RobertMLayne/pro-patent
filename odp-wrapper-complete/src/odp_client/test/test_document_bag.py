...
class TestDocumentBag(unittest.TestCase):
    """DocumentBag unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DocumentBag:
        """Test DocumentBag
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DocumentBag`
        """
        model = DocumentBag()
        if include_optional:
            return DocumentBag(
                document_bag = [
                    openapi_client.models.document_bag_document_bag_inner.DocumentBag_documentBag_inner(
