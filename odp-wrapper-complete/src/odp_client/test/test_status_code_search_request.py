...
class TestStatusCodeSearchRequest(unittest.TestCase):
    """StatusCodeSearchRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StatusCodeSearchRequest:
        """Test StatusCodeSearchRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StatusCodeSearchRequest`
        """
        model = StatusCodeSearchRequest()
        if include_optional:
            return StatusCodeSearchRequest(
    ...
    def testStatusCodeSearchRequest(self):
        """Test StatusCodeSearchRequest"""
