...
class TestApiV1DatasetsProductsSearchGet404Response(unittest.TestCase):
    """ApiV1DatasetsProductsSearchGet404Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiV1DatasetsProductsSearchGet404Response:
        """Test ApiV1DatasetsProductsSearchGet404Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiV1DatasetsProductsSearchGet404Response`
        """
        model = ApiV1DatasetsProductsSearchGet404Response()
        if include_optional:
            return ApiV1DatasetsProductsSearchGet404Response(
                code = 404,
                error = Not Found,
                error_details = No matching records found,
    ...
    def testApiV1DatasetsProductsSearchGet404Response(self):
        """Test ApiV1DatasetsProductsSearchGet404Response"""
