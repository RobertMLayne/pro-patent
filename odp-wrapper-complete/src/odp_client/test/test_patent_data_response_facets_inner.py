...
class TestPatentDataResponseFacetsInner(unittest.TestCase):
    """PatentDataResponseFacetsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatentDataResponseFacetsInner:
        """Test PatentDataResponseFacetsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatentDataResponseFacetsInner`
        """
        model = PatentDataResponseFacetsInner()
        if include_optional:
            return PatentDataResponseFacetsInner(
    ...
    def testPatentDataResponseFacetsInner(self):
        """Test PatentDataResponseFacetsInner"""
