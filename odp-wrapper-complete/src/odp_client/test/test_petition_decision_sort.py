...
class TestPetitionDecisionSort(unittest.TestCase):
    """PetitionDecisionSort unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PetitionDecisionSort:
        """Test PetitionDecisionSort
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PetitionDecisionSort`
        """
        model = PetitionDecisionSort()
        if include_optional:
            return PetitionDecisionSort(
    ...
    def testPetitionDecisionSort(self):
        """Test PetitionDecisionSort"""
