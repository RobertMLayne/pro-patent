...
class TestPetitionDecisionAndDocuments(unittest.TestCase):
    """PetitionDecisionAndDocuments unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PetitionDecisionAndDocuments:
        """Test PetitionDecisionAndDocuments
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PetitionDecisionAndDocuments`
        """
        model = PetitionDecisionAndDocuments()
        if include_optional:
            return PetitionDecisionAndDocuments(
                document_bag = [
    ...
    def testPetitionDecisionAndDocuments(self):
        """Test PetitionDecisionAndDocuments"""
