...
class TestParentContinuityData(unittest.TestCase):
    """ParentContinuityData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ParentContinuityData:
        """Test ParentContinuityData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ParentContinuityData`
        """
        model = ParentContinuityData()
        if include_optional:
            return ParentContinuityData(
    ...
    def testParentContinuityData(self):
        """Test ParentContinuityData"""
