...
class TestPetitionDecision(unittest.TestCase):
    """PetitionDecision unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PetitionDecision:
        """Test PetitionDecision
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PetitionDecision`
        """
        model = PetitionDecision()
        if include_optional:
