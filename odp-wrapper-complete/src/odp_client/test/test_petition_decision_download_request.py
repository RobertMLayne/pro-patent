...
class TestPetitionDecisionDownloadRequest(unittest.TestCase):
    """PetitionDecisionDownloadRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PetitionDecisionDownloadRequest:
        """Test PetitionDecisionDownloadRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PetitionDecisionDownloadRequest`
        """
        model = PetitionDecisionDownloadRequest()
        if include_optional:
            return PetitionDecisionDownloadRequest(
                q = 'finalDecidingOfficeName:OFFICE OF PETITIONS',
                filters = [
                    openapi_client.models.petition_decision_filter.PetitionDecisionFilter(
                        name = 'decisionTypeCodeDescriptionText', 
                        value = [
                            'DENIED'
                            ], )
                    ],
                range_filters = [
                    openapi_client.models.petition_decision_range.PetitionDecisionRange(
                        field = 'petitionMailDate', 
                        value_from = '2022-08-04', 
                        value_to = '2025-08-04', )
                    ],
                sort = [
                    openapi_client.models.petition_decision_sort.PetitionDecisionSort(
                        field = 'petitionMailDate', 
                        order = 'desc', )
                    ],
                fields = ["applicationNumberText","patentNumber","firstApplicantName","petitionMailDate","decisionPetitionTypeCode","decisionTypeCodeDescriptionText","decisionMailDate","finalDecidingOfficeName","businessEntityStatusCategory","groupArtUnitNumber"],
    ...
    def testPetitionDecisionDownloadRequest(self):
        """Test PetitionDecisionDownloadRequest"""
