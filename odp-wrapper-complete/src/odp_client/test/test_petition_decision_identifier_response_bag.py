...
class TestPetitionDecisionIdentifierResponseBag(unittest.TestCase):
    """PetitionDecisionIdentifierResponseBag unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PetitionDecisionIdentifierResponseBag:
        """Test PetitionDecisionIdentifierResponseBag
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PetitionDecisionIdentifierResponseBag`
        """
        model = PetitionDecisionIdentifierResponseBag()
        if include_optional:
            return PetitionDecisionIdentifierResponseBag(
                count = 1,
                petition_decision_data_bag = [
                    openapi_client.models.petition_decision_and_documents.PetitionDecisionAndDocuments(
                        document_bag = [
                            openapi_client.models.petition_decision_document.PetitionDecisionDocument(
                                application_number_text = '1556987', 
                                official_date = '2020-08-31T01:20:29.000-0400', 
                                document_identifier = 'M98QOH0NWFYTX17', 
                                document_code = 'PETDEC', 
                                document_code_description_text = 'Petition Decision', 
                                document_direction_category = 'OUTGOING', 
                                download_option_bag = [
                                    openapi_client.models.petition_decision_document_download_option_bag_inner.PetitionDecisionDocument_downloadOptionBag_inner(
                                        mime_type_identifier = 'PDF', 
                                        document_uri = 'https://api.uspto.gov/api/v1/patent/application/documents/16123123/LDXBTPQ7XBLUEX3.pdf', 
    ...
    def testPetitionDecisionIdentifierResponseBag(self):
        """Test PetitionDecisionIdentifierResponseBag"""
