...
class TestPetitionDecisionRange(unittest.TestCase):
    """PetitionDecisionRange unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PetitionDecisionRange:
        """Test PetitionDecisionRange
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PetitionDecisionRange`
        """
        model = PetitionDecisionRange()
        if include_optional:
            return PetitionDecisionRange(
                var_field = 'petitionMailDate',
    ...
    def testPetitionDecisionRange(self):
        """Test PetitionDecisionRange"""
