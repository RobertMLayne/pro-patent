...
from openapi_client.api.bulk_data_sets_api import BulkDataSetsApi


class TestBulkDataSetsApi(unittest.TestCase):
    """BulkDataSetsApi unit test stubs"""

    def setUp(self) -> None:
        self.api = BulkDataSetsApi()

    def tearDown(self) -> None:
        pass

    def test_api_v1_datasets_products_product_identifier_get(self) -> None:
        """Test case for api_v1_datasets_products_product_identifier_get

        Bulk data- find a product by its identifier (shortName)
        """
        pass

    def test_api_v1_datasets_products_search_get(self) -> None:
        """Test case for api_v1_datasets_products_search_get
