...
class TestApiV1PatentStatusCodesPost400Response(unittest.TestCase):
    """ApiV1PatentStatusCodesPost400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiV1PatentStatusCodesPost400Response:
        """Test ApiV1PatentStatusCodesPost400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiV1PatentStatusCodesPost400Response`
        """
        model = ApiV1PatentStatusCodesPost400Response()
        if include_optional:
            return ApiV1PatentStatusCodesPost400Response(
                code = 400,
                error = Bad Request,
                error_details = Invalid request, review search request and try again,
    ...
    def testApiV1PatentStatusCodesPost400Response(self):
        """Test ApiV1PatentStatusCodesPost400Response"""
