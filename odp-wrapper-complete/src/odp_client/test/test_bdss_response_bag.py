...
class TestBdssResponseBag(unittest.TestCase):
    """BdssResponseBag unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BdssResponseBag:
        """Test BdssResponseBag
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BdssResponseBag`
        """
        model = BdssResponseBag()
        if include_optional:
            return BdssResponseBag(
                count = 25,
                ...
                facets = openapi_client.models.facets.Facets(
                    product_label_array_text = [
