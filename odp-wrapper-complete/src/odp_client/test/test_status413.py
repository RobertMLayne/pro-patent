...
class TestStatus413(unittest.TestCase):
    """Status413 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Status413:
        """Test Status413
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Status413`
        """
        model = Status413()
        if include_optional:
            return Status413(
                ...
                detailed_message = 'Response payload exceeds allowed limit of 6MB, please refine your search criteria or reduce payload size by reducing page size',
