...
class TestAssignmentAssignorBagInner(unittest.TestCase):
    """AssignmentAssignorBagInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssignmentAssignorBagInner:
        """Test AssignmentAssignorBagInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssignmentAssignorBagInner`
        """
        model = AssignmentAssignorBagInner()
        if include_optional:
            return AssignmentAssignorBagInner(
    ...
    def testAssignmentAssignorBagInner(self):
        """Test AssignmentAssignorBagInner"""
