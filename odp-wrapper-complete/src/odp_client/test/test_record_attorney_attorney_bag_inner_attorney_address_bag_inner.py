...
class TestRecordAttorneyAttorneyBagInnerAttorneyAddressBagInner(unittest.TestCase):
    """RecordAttorneyAttorneyBagInnerAttorneyAddressBagInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RecordAttorneyAttorneyBagInnerAttorneyAddressBagInner:
        """Test RecordAttorneyAttorneyBagInnerAttorneyAddressBagInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RecordAttorneyAttorneyBagInnerAttorneyAddressBagInner`
        """
        model = RecordAttorneyAttorneyBagInnerAttorneyAddressBagInner()
        if include_optional:
            return RecordAttorneyAttorneyBagInnerAttorneyAddressBagInner(
    ...
    def testRecordAttorneyAttorneyBagInnerAttorneyAddressBagInner(self):
        """Test RecordAttorneyAttorneyBagInnerAttorneyAddressBagInner"""
