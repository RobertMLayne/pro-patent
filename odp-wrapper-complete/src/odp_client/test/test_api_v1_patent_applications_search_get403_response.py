...
class TestApiV1PatentApplicationsSearchGet403Response(unittest.TestCase):
    """ApiV1PatentApplicationsSearchGet403Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiV1PatentApplicationsSearchGet403Response:
        """Test ApiV1PatentApplicationsSearchGet403Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiV1PatentApplicationsSearchGet403Response`
        """
        model = ApiV1PatentApplicationsSearchGet403Response()
        if include_optional:
            return ApiV1PatentApplicationsSearchGet403Response(
                code = 403,
                error = Forbidden
            )
        else:
    ...
    def testApiV1PatentApplicationsSearchGet403Response(self):
        """Test ApiV1PatentApplicationsSearchGet403Response"""
