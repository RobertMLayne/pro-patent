...
class TestResponse403(unittest.TestCase):
    """Response403 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> Response403:
        """Test Response403
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `Response403`
        """
        model = Response403()
        if include_optional:
            return Response403(
