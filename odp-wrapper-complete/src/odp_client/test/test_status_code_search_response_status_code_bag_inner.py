...
class TestStatusCodeSearchResponseStatusCodeBagInner(unittest.TestCase):
    """StatusCodeSearchResponseStatusCodeBagInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StatusCodeSearchResponseStatusCodeBagInner:
        """Test StatusCodeSearchResponseStatusCodeBagInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StatusCodeSearchResponseStatusCodeBagInner`
        """
        model = StatusCodeSearchResponseStatusCodeBagInner()
        if include_optional:
            return StatusCodeSearchResponseStatusCodeBagInner(
                application_status_code = 60,
    ...
    def testStatusCodeSearchResponseStatusCodeBagInner(self):
        """Test StatusCodeSearchResponseStatusCodeBagInner"""
