...
class TestFacetsMimeTypeIdentifierArrayTextInner(unittest.TestCase):
    """FacetsMimeTypeIdentifierArrayTextInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FacetsMimeTypeIdentifierArrayTextInner:
        """Test FacetsMimeTypeIdentifierArrayTextInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FacetsMimeTypeIdentifierArrayTextInner`
        """
        model = FacetsMimeTypeIdentifierArrayTextInner()
        if include_optional:
            return FacetsMimeTypeIdentifierArrayTextInner(
                value = 'XML',
                count = 1
            )
        else:
    ...
    def testFacetsMimeTypeIdentifierArrayTextInner(self):
        """Test FacetsMimeTypeIdentifierArrayTextInner"""
