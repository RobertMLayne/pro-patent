...
from openapi_client.models.api_v1_datasets_products_search_get400_response import (
    ApiV1DatasetsProductsSearchGet400Response,
)


class TestApiV1DatasetsProductsSearchGet400Response(unittest.TestCase):
    """ApiV1DatasetsProductsSearchGet400Response unit test stubs"""
    ...
    def make_instance(
        ...
        """Test ApiV1DatasetsProductsSearchGet400Response
        include_optional is a boolean, when False only required
        params are included, when True both required and
        optional params are included"""
        # uncomment below to create an instance of `ApiV1DatasetsProductsSearchGet400Response`
        """
        model = ApiV1DatasetsProductsSearchGet400Response()
        if include_optional:
            return ApiV1DatasetsProductsSearchGet400Response(
                code = 400,
                error = Bad Request,
                error_details = Invalid request, review data requested try again,
    ...
    def testApiV1DatasetsProductsSearchGet400Response(self):
        """Test ApiV1DatasetsProductsSearchGet400Response"""
