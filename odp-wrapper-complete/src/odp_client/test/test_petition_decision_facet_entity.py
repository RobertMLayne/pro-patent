...
class TestPetitionDecisionFacetEntity(unittest.TestCase):
    """PetitionDecisionFacetEntity unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PetitionDecisionFacetEntity:
        """Test PetitionDecisionFacetEntity
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PetitionDecisionFacetEntity`
        """
        model = PetitionDecisionFacetEntity()
        if include_optional:
            return PetitionDecisionFacetEntity(
                value = 'Facet Value',
                count = 1
            )
        else:
    ...
    def testPetitionDecisionFacetEntity(self):
        """Test PetitionDecisionFacetEntity"""
