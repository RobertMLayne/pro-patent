...
class TestPatentDataResponseFacetsInnerApplicationStatusCodeInner(unittest.TestCase):
    """PatentDataResponseFacetsInnerApplicationStatusCodeInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatentDataResponseFacetsInnerApplicationStatusCodeInner:
        """Test PatentDataResponseFacetsInnerApplicationStatusCodeInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatentDataResponseFacetsInnerApplicationStatusCodeInner`
        """
        model = PatentDataResponseFacetsInnerApplicationStatusCodeInner()
        if include_optional:
            return PatentDataResponseFacetsInnerApplicationStatusCodeInner(
                value = 'Utility',
                count = 44673
            )
        else:
    ...
    def testPatentDataResponseFacetsInnerApplicationStatusCodeInner(self):
        """Test PatentDataResponseFacetsInnerApplicationStatusCodeInner"""
