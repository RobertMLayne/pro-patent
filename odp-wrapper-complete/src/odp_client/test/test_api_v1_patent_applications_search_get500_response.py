...
class TestApiV1PatentApplicationsSearchGet500Response(unittest.TestCase):
    """ApiV1PatentApplicationsSearchGet500Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiV1PatentApplicationsSearchGet500Response:
        """Test ApiV1PatentApplicationsSearchGet500Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiV1PatentApplicationsSearchGet500Response`
        """
        model = ApiV1PatentApplicationsSearchGet500Response()
        if include_optional:
            return ApiV1PatentApplicationsSearchGet500Response(
                code = 500,
                error = Internal Server Error,
                error_details = Internal Server Error. Please contact Help Desk.,
    ...
    def testApiV1PatentApplicationsSearchGet500Response(self):
        """Test ApiV1PatentApplicationsSearchGet500Response"""
