...
class TestApplicationMetaDataApplicantBagInnerCorrespondenceAddressBagInner(unittest.TestCase):
    """ApplicationMetaDataApplicantBagInnerCorrespondenceAddressBagInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplicationMetaDataApplicantBagInnerCorrespondenceAddressBagInner:
        """Test ApplicationMetaDataApplicantBagInnerCorrespondenceAddressBagInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplicationMetaDataApplicantBagInnerCorrespondenceAddressBagInner`
        """
        model = ApplicationMetaDataApplicantBagInnerCorrespondenceAddressBagInner()
        if include_optional:
            return ApplicationMetaDataApplicantBagInnerCorrespondenceAddressBagInner(
    ...
    def testApplicationMetaDataApplicantBagInnerCorrespondenceAddressBagInner(self):
        """Test ApplicationMetaDataApplicantBagInnerCorrespondenceAddressBagInner"""
