...
class TestPetitionDecisionFacet(unittest.TestCase):
    """PetitionDecisionFacet unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PetitionDecisionFacet:
        """Test PetitionDecisionFacet
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PetitionDecisionFacet`
        """
        model = PetitionDecisionFacet()
        if include_optional:
            return PetitionDecisionFacet(
                technology_center = [
    ...
    def testPetitionDecisionFacet(self):
        """Test PetitionDecisionFacet"""
