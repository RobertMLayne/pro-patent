...
class TestAssignmentCorrespondenceAddressBagInner(unittest.TestCase):
    """AssignmentCorrespondenceAddressBagInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AssignmentCorrespondenceAddressBagInner:
        """Test AssignmentCorrespondenceAddressBagInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AssignmentCorrespondenceAddressBagInner`
        """
        model = AssignmentCorrespondenceAddressBagInner()
        if include_optional:
            return AssignmentCorrespondenceAddressBagInner(
    ...
    def testAssignmentCorrespondenceAddressBagInner(self):
        """Test AssignmentCorrespondenceAddressBagInner"""
