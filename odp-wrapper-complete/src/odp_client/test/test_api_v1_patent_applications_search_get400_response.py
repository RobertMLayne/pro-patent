...
class TestApiV1PatentApplicationsSearchGet400Response(unittest.TestCase):
    """ApiV1PatentApplicationsSearchGet400Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApiV1PatentApplicationsSearchGet400Response:
        """Test ApiV1PatentApplicationsSearchGet400Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApiV1PatentApplicationsSearchGet400Response`
        """
        model = ApiV1PatentApplicationsSearchGet400Response()
        if include_optional:
            return ApiV1PatentApplicationsSearchGet400Response(
                code = 400,
                error = Bad Request,
                error_details = Invalid request, review patent data request filter section and try again,
    ...
    def testApiV1PatentApplicationsSearchGet400Response(self):
        """Test ApiV1PatentApplicationsSearchGet400Response"""
