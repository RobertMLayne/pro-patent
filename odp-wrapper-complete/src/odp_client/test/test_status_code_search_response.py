...
class TestStatusCodeSearchResponse(unittest.TestCase):
    """StatusCodeSearchResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StatusCodeSearchResponse:
        """Test StatusCodeSearchResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StatusCodeSearchResponse`
        """
        model = StatusCodeSearchResponse()
        if include_optional:
            return StatusCodeSearchResponse(
                count = 1,
                status_code_bag = [
                    openapi_client.models.status_code_search_response_status_code_bag_inner.StatusCodeSearchResponse_statusCodeBag_inner(
    ...
    def testStatusCodeSearchResponse(self):
        """Test StatusCodeSearchResponse"""
