...
class TestPatentTermAdjustmentPatentTermAdjustmentHistoryDataBagInner(unittest.TestCase):
    """PatentTermAdjustmentPatentTermAdjustmentHistoryDataBagInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatentTermAdjustmentPatentTermAdjustmentHistoryDataBagInner:
        """Test PatentTermAdjustmentPatentTermAdjustmentHistoryDataBagInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatentTermAdjustmentPatentTermAdjustmentHistoryDataBagInner`
        """
        model = PatentTermAdjustmentPatentTermAdjustmentHistoryDataBagInner()
        if include_optional:
            return PatentTermAdjustmentPatentTermAdjustmentHistoryDataBagInner(
    ...
    def testPatentTermAdjustmentPatentTermAdjustmentHistoryDataBagInner(self):
        """Test PatentTermAdjustmentPatentTermAdjustmentHistoryDataBagInner"""
