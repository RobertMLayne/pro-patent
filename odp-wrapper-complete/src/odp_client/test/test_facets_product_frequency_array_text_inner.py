...
class TestFacetsProductFrequencyArrayTextInner(unittest.TestCase):
    """FacetsProductFrequencyArrayTextInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FacetsProductFrequencyArrayTextInner:
        """Test FacetsProductFrequencyArrayTextInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FacetsProductFrequencyArrayTextInner`
        """
        model = FacetsProductFrequencyArrayTextInner()
        if include_optional:
            return FacetsProductFrequencyArrayTextInner(
                value = 'DAILY',
                count = 1
            )
        else:
    ...
    def testFacetsProductFrequencyArrayTextInner(self):
        """Test FacetsProductFrequencyArrayTextInner"""
