...
class TestFacetsProductCategoryArrayTextInner(unittest.TestCase):
    """FacetsProductCategoryArrayTextInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FacetsProductCategoryArrayTextInner:
        """Test FacetsProductCategoryArrayTextInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FacetsProductCategoryArrayTextInner`
        """
        model = FacetsProductCategoryArrayTextInner()
        if include_optional:
            return FacetsProductCategoryArrayTextInner(
    ...
    def testFacetsProductCategoryArrayTextInner(self):
        """Test FacetsProductCategoryArrayTextInner"""
