...
class TestPetitionDecisionDocument(unittest.TestCase):
    """PetitionDecisionDocument unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PetitionDecisionDocument:
        """Test PetitionDecisionDocument
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PetitionDecisionDocument`
        """
        model = PetitionDecisionDocument()
        if include_optional:
            return PetitionDecisionDocument(
    ...
    def testPetitionDecisionDocument(self):
        """Test PetitionDecisionDocument"""
