...
class TestPetitionDecisionDocumentDownloadOptionBagInner(unittest.TestCase):
    """PetitionDecisionDocumentDownloadOptionBagInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PetitionDecisionDocumentDownloadOptionBagInner:
        """Test PetitionDecisionDocumentDownloadOptionBagInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PetitionDecisionDocumentDownloadOptionBagInner`
        """
        model = PetitionDecisionDocumentDownloadOptionBagInner()
        if include_optional:
            return PetitionDecisionDocumentDownloadOptionBagInner(
    ...
    def testPetitionDecisionDocumentDownloadOptionBagInner(self):
        """Test PetitionDecisionDocumentDownloadOptionBagInner"""
