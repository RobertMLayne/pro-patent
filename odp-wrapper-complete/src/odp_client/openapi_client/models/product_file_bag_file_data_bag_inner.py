...
class ProductFileBagFileDataBagInner(BaseModel):
    """
    ProductFileBagFileDataBagInner
    """ # noqa: E501
    file_name: Optional[StrictStr] = Field(default=None, alias="fileName")
    file_size: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, alias="fileSize")
    file_data_from_date: Optional[date] = Field(default=None, alias="fileDataFromDate")
    file_data_to_date: Optional[date] = Field(default=None, alias="fileDataToDate")
    file_type_text: Optional[StrictStr] = Field(default=None, alias="fileTypeText")
    file_download_uri: Optional[StrictStr] = Field(default=None, alias="fileDownloadURI")
    file_release_date: Optional[date] = Field(default=None, alias="fileReleaseDate")
    file_date: Optional[date] = Field(default=None, alias="fileDate")
    file_last_modified_date_time: Optional[date] = Field(default=None, alias="fileLastModifiedDateTime")
    __properties: ClassVar[List[str]] = ["fileName", "fileSize", "fileDataFromDate", "fileDataToDate", "fileTypeText", "fileDownloadURI", "fileReleaseDate", "fileDate", "fileLastModifiedDateTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fileDataFromDate": obj.get("fileDataFromDate"),
            "fileDataToDate": obj.get("fileDataToDate"),
            "fileTypeText": obj.get("fileTypeText"),
            "fileDownloadURI": obj.get("fileDownloadURI"),
            "fileReleaseDate": obj.get("fileReleaseDate"),
            "fileDate": obj.get("fileDate"),
            "fileLastModifiedDateTime": obj.get("fileLastModifiedDateTime")
        })
        return _obj
