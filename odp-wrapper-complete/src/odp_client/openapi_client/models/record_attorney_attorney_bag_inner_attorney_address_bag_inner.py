...
class RecordAttorneyAttorneyBagInnerAttorneyAddressBagInner(BaseModel):
    """
    RecordAttorneyAttorneyBagInnerAttorneyAddressBagInner
    """  # noqa: E501

    name_line_one_text: Optional[StrictStr] = Field(
        default=None, alias="nameLineOneText"
    )
    name_line_two_text: Optional[StrictStr] = Field(
        default=None, alias="nameLineTwoText"
    )
    address_line_one_text: Optional[StrictStr] = Field(
        default=None, alias="addressLineOneText"
    )
    address_line_two_text: Optional[StrictStr] = Field(
        default=None, alias="addressLineTwoText"
    )
    geographic_region_name: Optional[StrictStr] = Field(
        default=None, alias="geographicRegionName"
    )
    geographic_region_code: Optional[StrictStr] = Field(
        default=None, alias="geographicRegionCode"
    )
    ...
    country_name: Optional[StrictStr] = Field(
        default=None, alias="countryName"
    )
