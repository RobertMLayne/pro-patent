...
class ApplicationMetaDataEntityStatusData(BaseModel):
    """
    Indicates the applicant's entity status
    """ # noqa: E501
    small_entity_status_indicator: Optional[StrictBool] = Field(default=None, description="Indicates whether the applicant qualifies for small entity status", alias="smallEntityStatusIndicator")
    business_entity_status_category: Optional[StrictStr] = Field(default=None, description="Status of business entity being established for the purpose of paying a fee such as a filing fee and a maintenance fee", alias="businessEntityStatusCategory")
    __properties: ClassVar[List[str]] = ["smallEntityStatusIndicator", "businessEntityStatusCategory"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "smallEntityStatusIndicator": obj.get("smallEntityStatusIndicator"),
