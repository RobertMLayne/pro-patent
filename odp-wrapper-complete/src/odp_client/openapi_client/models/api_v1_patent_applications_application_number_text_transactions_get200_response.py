...
class ApiV1PatentApplicationsApplicationNumberTextTransactionsGet200Response(BaseModel):
    """
    ApiV1PatentApplicationsApplicationNumberTextTransactionsGet200Response
    """ # noqa: E501
    count: Optional[StrictInt] = None
    patent_file_wrapper_data_bag: Optional[List[ApiV1PatentApplicationsApplicationNumberTextTransactionsGet200ResponsePatentFileWrapperDataBagInner]] = Field(default=None, alias="patentFileWrapperDataBag")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "patentFileWrapperDataBag": [ApiV1PatentApplicationsApplicationNumberTextTransactionsGet200ResponsePatentFileWrapperDataBagInner.from_dict(_item) for _item in obj["patentFileWrapperDataBag"]] if obj.get("patentFileWrapperDataBag") is not None else None
        })
        return _obj
