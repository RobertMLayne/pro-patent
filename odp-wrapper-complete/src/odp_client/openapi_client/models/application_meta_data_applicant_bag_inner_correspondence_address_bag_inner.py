...
class ApplicationMetaDataApplicantBagInnerCorrespondenceAddressBagInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["nameLineOneText", "nameLineTwoText", "geographicRegionName", "geographicRegionCode", "cityName", "countryCode", "countryName", "postalAddressCategory"]
