...
class Pagination(BaseModel):
    ...
    """ # noqa: E501
    offset: Optional[Annotated[int, Field(strict=True, ge=0)]] = Field(default=0, description="Start")
    limit: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=25, description="Maximum number of patent records to be returned in response")
