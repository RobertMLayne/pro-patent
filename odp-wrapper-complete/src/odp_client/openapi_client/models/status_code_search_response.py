...
class StatusCodeSearchResponse(BaseModel):
    ...
    status_code_bag: Optional[List[StatusCodeSearchResponseStatusCodeBagInner]] = Field(default=None, alias="statusCodeBag")
    request_identifier: Optional[StrictStr] = Field(default=None, alias="requestIdentifier")
    __properties: ClassVar[List[str]] = ["count", "statusCodeBag", "requestIdentifier"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in status_code_bag (list)
        _items = []
        if self.status_code_bag:
            for _item_status_code_bag in self.status_code_bag:
                if _item_status_code_bag:
                    _items.append(_item_status_code_bag.to_dict())
            _dict['statusCodeBag'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "statusCodeBag": [StatusCodeSearchResponseStatusCodeBagInner.from_dict(_item) for _item in obj["statusCodeBag"]] if obj.get("statusCodeBag") is not None else None,
