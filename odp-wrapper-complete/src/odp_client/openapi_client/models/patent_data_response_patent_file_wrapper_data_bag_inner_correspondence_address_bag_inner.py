...
class PatentDataResponsePatentFileWrapperDataBagInnerCorrespondenceAddressBagInner(BaseModel):
    """
    PatentDataResponsePatentFileWrapperDataBagInnerCorrespondenceAddressBagInner
    """ # noqa: E501
    name_line_one_text: Optional[StrictStr] = Field(default=None, alias="nameLineOneText")
    name_line_two_text: Optional[StrictStr] = Field(default=None, alias="nameLineTwoText")
    address_line_one_text: Optional[StrictStr] = Field(default=None, alias="addressLineOneText")
    address_line_two_text: Optional[StrictStr] = Field(default=None, alias="addressLineTwoText")
    geographic_region_name: Optional[StrictStr] = Field(default=None, alias="geographicRegionName")
    geographic_region_code: Optional[StrictStr] = Field(default=None, alias="geographicRegionCode")
    ...
    postal_address_category: Optional[StrictStr] = Field(default=None, alias="postalAddressCategory")
    __properties: ClassVar[List[str]] = ["nameLineOneText", "nameLineTwoText", "addressLineOneText", "addressLineTwoText", "geographicRegionName", "geographicRegionCode", "postalCode", "cityName", "countryCode", "countryName", "postalAddressCategory"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "nameLineOneText": obj.get("nameLineOneText"),
            "nameLineTwoText": obj.get("nameLineTwoText"),
            "addressLineOneText": obj.get("addressLineOneText"),
            "addressLineTwoText": obj.get("addressLineTwoText"),
            "geographicRegionName": obj.get("geographicRegionName"),
            "geographicRegionCode": obj.get("geographicRegionCode"),
            "postalCode": obj.get("postalCode"),
            "cityName": obj.get("cityName"),
            "countryCode": obj.get("countryCode"),
            "countryName": obj.get("countryName"),
            "postalAddressCategory": obj.get("postalAddressCategory")
        })
        return _obj
