...
class ApplicationMetaDataApplicantBagInner(BaseModel):
    """
    ApplicationMetaDataApplicantBagInner
    """ # noqa: E501
    applicant_name_text: Optional[StrictStr] = Field(default=None, alias="applicantNameText")
    ...
    correspondence_address_bag: Optional[List[ApplicationMetaDataApplicantBagInnerCorrespondenceAddressBagInner]] = Field(default=None, alias="correspondenceAddressBag")
    __properties: ClassVar[List[str]] = ["applicantNameText", "firstName", "middleName", "lastName", "preferredName", "namePrefix", "nameSuffix", "countryCode", "correspondenceAddressBag"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "applicantNameText": obj.get("applicantNameText"),
            ...
            "correspondenceAddressBag": [ApplicationMetaDataApplicantBagInnerCorrespondenceAddressBagInner.from_dict(_item) for _item in obj["correspondenceAddressBag"]] if obj.get("correspondenceAddressBag") is not None else None
        })
        return _obj
