...
class PetitionDecisionDownloadRequest(BaseModel):
    """
    PetitionDecisionDownloadRequest
    """ # noqa: E501
    q: Optional[StrictStr] = Field(default=None, description="Search by field value or pass opensearch string query syntax")
    filters: Optional[List[PetitionDecisionFilter]] = None
    range_filters: Optional[List[PetitionDecisionRange]] = Field(default=None, alias="rangeFilters")
    sort: Optional[List[PetitionDecisionSort]] = None
    fields: Optional[List[StrictStr]] = None
    pagination: Optional[Pagination] = None
    format: Optional[StrictStr] = Field(default=None, description="Download format. pdf,xml or docs")
    __properties: ClassVar[List[str]] = ["q", "filters", "rangeFilters", "sort", "fields", "pagination", "format"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.range_filters:
            for _item_range_filters in self.range_filters:
                if _item_range_filters:
                    _items.append(_item_range_filters.to_dict())
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "q": obj.get("q"),
            "filters": [PetitionDecisionFilter.from_dict(_item) for _item in obj["filters"]] if obj.get("filters") is not None else None,
            "rangeFilters": [PetitionDecisionRange.from_dict(_item) for _item in obj["rangeFilters"]] if obj.get("rangeFilters") is not None else None,
            "sort": [PetitionDecisionSort.from_dict(_item) for _item in obj["sort"]] if obj.get("sort") is not None else None,
