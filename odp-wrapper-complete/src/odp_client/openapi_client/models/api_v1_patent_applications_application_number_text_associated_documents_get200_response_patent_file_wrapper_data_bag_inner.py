...
class ApiV1PatentApplicationsApplicationNumberTextAssociatedDocumentsGet200ResponsePatentFileWrapperDataBagInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["applicationNumberText", "pgpubDocumentMetaData", "grantDocumentMetaData", "requestIdentifier"]
