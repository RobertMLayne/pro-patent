...
class AssignmentAssigneeBagInnerAssigneeAddress(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["addressLineOneText", "addressLineTwoText", "cityName", "geographicRegionName", "geographicRegionCode", "countryName", "postalCode"]
