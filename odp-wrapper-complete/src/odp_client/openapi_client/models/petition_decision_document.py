...
class PetitionDecisionDocument(BaseModel):
    """
    ...
    download_option_bag: Optional[List[PetitionDecisionDocumentDownloadOptionBagInner]] = Field(default=None, alias="downloadOptionBag")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "downloadOptionBag": [PetitionDecisionDocumentDownloadOptionBagInner.from_dict(_item) for _item in obj["downloadOptionBag"]] if obj.get("downloadOptionBag") is not None else None
        })
        return _obj
