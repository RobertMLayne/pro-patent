...
class AssignmentCorrespondenceAddressBagInner(BaseModel):
    """
    AssignmentCorrespondenceAddressBagInner
    """ # noqa: E501
    correspondent_name_text: Optional[StrictStr] = Field(default=None, alias="correspondentNameText")
    ...
    address_line_three_text: Optional[StrictStr] = Field(default=None, alias="addressLineThreeText")
    address_line_four_text: Optional[StrictStr] = Field(default=None, alias="addressLineFourText")
    __properties: ClassVar[List[str]] = ["correspondentNameText", "addressLineOneText", "addressLineTwoText", "addressLineThreeText", "addressLineFourText"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "correspondentNameText": obj.get("correspondentNameText"),
            "addressLineOneText": obj.get("addressLineOneText"),
            "addressLineTwoText": obj.get("addressLineTwoText"),
            "addressLineThreeText": obj.get("addressLineThreeText"),
            "addressLineFourText": obj.get("addressLineFourText")
        })
        return _obj
