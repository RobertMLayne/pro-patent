...
class EventData(BaseModel):
    ...
    event_date: Optional[StrictStr] = Field(default=None, description="The date the patent case action was recorded.", alias="eventDate")
    __properties: ClassVar[List[str]] = ["eventCode", "eventDescriptionText", "eventDate"]
