...
class AssignmentAssignorBagInner(BaseModel):
    """
    AssignmentAssignorBagInner
    """ # noqa: E501
    assignor_name: Optional[StrictStr] = Field(default=None, alias="assignorName")
    execution_date: Optional[StrictStr] = Field(default=None, alias="executionDate")
    __properties: ClassVar[List[str]] = ["assignorName", "executionDate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "assignorName": obj.get("assignorName"),
