...
class PGPubFileMetaData(BaseModel):
    ...
    """ # noqa: E501
    zip_file_name: Optional[StrictStr] = Field(default=None, alias="zipFileName")
    product_identifier: Optional[StrictStr] = Field(default=None, alias="productIdentifier")
    file_location_uri: Optional[StrictStr] = Field(default=None, alias="fileLocationURI")
    file_create_date_time: Optional[StrictStr] = Field(default=None, alias="fileCreateDateTime")
    xml_file_name: Optional[StrictStr] = Field(default=None, alias="xmlFileName")
    __properties: ClassVar[List[str]] = ["zipFileName", "productIdentifier", "fileLocationURI", "fileCreateDateTime", "xmlFileName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fileLocationURI": obj.get("fileLocationURI"),
            "fileCreateDateTime": obj.get("fileCreateDateTime"),
