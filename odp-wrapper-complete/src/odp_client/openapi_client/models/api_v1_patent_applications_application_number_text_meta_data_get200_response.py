...
class ApiV1PatentApplicationsApplicationNumberTextMetaDataGet200Response(BaseModel):
    """
    ApiV1PatentApplicationsApplicationNumberTextMetaDataGet200Response
    """ # noqa: E501
    count: Optional[Any] = None
    patent_file_wrapper_data_bag: Optional[List[ApiV1PatentApplicationsApplicationNumberTextMetaDataGet200ResponsePatentFileWrapperDataBagInner]] = Field(default=None, alias="patentFileWrapperDataBag")
    request_identifier: Optional[Any] = Field(default=None, alias="requestIdentifier")
    __properties: ClassVar[List[str]] = ["count", "patentFileWrapperDataBag", "requestIdentifier"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if request_identifier (nullable) is None
        # and model_fields_set contains the field
        if self.request_identifier is None and "request_identifier" in self.model_fields_set:
            _dict['requestIdentifier'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "patentFileWrapperDataBag": [ApiV1PatentApplicationsApplicationNumberTextMetaDataGet200ResponsePatentFileWrapperDataBagInner.from_dict(_item) for _item in obj["patentFileWrapperDataBag"]] if obj.get("patentFileWrapperDataBag") is not None else None,
