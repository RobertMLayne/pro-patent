...
class AssignmentAssigneeBagInner(BaseModel):
    """
    AssignmentAssigneeBagInner
    """ # noqa: E501
    assignee_name_text: Optional[StrictStr] = Field(default=None, alias="assigneeNameText")
    assignee_address: Optional[AssignmentAssigneeBagInnerAssigneeAddress] = Field(default=None, alias="assigneeAddress")
    __properties: ClassVar[List[str]] = ["assigneeNameText", "assigneeAddress"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of assignee_address
        if self.assignee_address:
            _dict['assigneeAddress'] = self.assignee_address.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "assigneeNameText": obj.get("assigneeNameText"),
            "assigneeAddress": AssignmentAssigneeBagInnerAssigneeAddress.from_dict(obj["assigneeAddress"]) if obj.get("assigneeAddress") is not None else None
        })
        return _obj
