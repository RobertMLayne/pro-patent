...
class ApiV1PatentApplicationsApplicationNumberTextGet500Response(BaseModel):
    """
    ApiV1PatentApplicationsApplicationNumberTextGet500Response
    """ # noqa: E501
    code: Optional[Any] = None
    error: Optional[Any] = None
    error_detailed: Optional[Any] = Field(default=None, alias="errorDetailed")
    request_identifier: Optional[Any] = Field(default=None, alias="requestIdentifier")
    __properties: ClassVar[List[str]] = ["code", "error", "errorDetailed", "requestIdentifier"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if error_detailed (nullable) is None
        # and model_fields_set contains the field
        if self.error_detailed is None and "error_detailed" in self.model_fields_set:
            _dict['errorDetailed'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "error": obj.get("error"),
            "errorDetailed": obj.get("errorDetailed"),
