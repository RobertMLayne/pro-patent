...
class PatentDataResponseFacetsInner(BaseModel):
    """
    PatentDataResponseFacetsInner
    """ # noqa: E501
    application_status_code: Optional[List[PatentDataResponseFacetsInnerApplicationStatusCodeInner]] = Field(default=None, alias="applicationStatusCode")
    __properties: ClassVar[List[str]] = ["applicationStatusCode"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in application_status_code (list)
        _items = []
        if self.application_status_code:
            for _item_application_status_code in self.application_status_code:
                if _item_application_status_code:
                    _items.append(_item_application_status_code.to_dict())
            _dict['applicationStatusCode'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "applicationStatusCode": [PatentDataResponseFacetsInnerApplicationStatusCodeInner.from_dict(_item) for _item in obj["applicationStatusCode"]] if obj.get("applicationStatusCode") is not None else None
        })
        return _obj
