...
class ProductFileBag(BaseModel):
    ...
    file_data_bag: Optional[List[ProductFileBagFileDataBagInner]] = Field(default=None, alias="fileDataBag")
    __properties: ClassVar[List[str]] = ["count", "fileDataBag"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in file_data_bag (list)
        _items = []
        if self.file_data_bag:
            for _item_file_data_bag in self.file_data_bag:
                if _item_file_data_bag:
                    _items.append(_item_file_data_bag.to_dict())
            _dict['fileDataBag'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "fileDataBag": [ProductFileBagFileDataBagInner.from_dict(_item) for _item in obj["fileDataBag"]] if obj.get("fileDataBag") is not None else None
        })
        return _obj
