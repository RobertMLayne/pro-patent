...
class DocumentBag(BaseModel):
    ...
    DocumentBag
    """ # noqa: E501
    document_bag: Optional[List[DocumentBagDocumentBagInner]] = Field(default=None, alias="documentBag")
    __properties: ClassVar[List[str]] = ["documentBag"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in document_bag (list)
        _items = []
        if self.document_bag:
            for _item_document_bag in self.document_bag:
                if _item_document_bag:
                    _items.append(_item_document_bag.to_dict())
            _dict['documentBag'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "documentBag": [DocumentBagDocumentBagInner.from_dict(_item) for _item in obj["documentBag"]] if obj.get("documentBag") is not None else None
        })
        return _obj
