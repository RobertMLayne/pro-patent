...
class Error(BaseModel):
    ...
    detailed_error: Optional[StrictStr] = Field(default=None, alias="detailedError")
    request_identifier: Optional[StrictStr] = Field(default=None, alias="requestIdentifier")
    __properties: ClassVar[List[str]] = ["code", "description", "detailedError", "requestIdentifier"]
    ...
    def code_validate_enum(cls, value):
        ...
        if value not in set([400, 403, 404, 413, 500]):
            raise ValueError("must be one of enum values (400, 403, 404, 413, 500)")
        return value
    ...
    def description_validate_enum(cls, value):
        ...
        if value not in set(['Bad Request', 'Unauthorized', 'Not Found', 'Payload Too Large', 'Internal Server Error']):
            raise ValueError("must be one of enum values ('Bad Request', 'Unauthorized', 'Not Found', 'Payload Too Large', 'Internal Server Error')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "detailedError": obj.get("detailedError"),
