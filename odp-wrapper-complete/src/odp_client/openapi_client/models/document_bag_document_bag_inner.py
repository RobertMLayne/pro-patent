...
class DocumentBagDocumentBagInner(BaseModel):
    """
    DocumentBagDocumentBagInner
    """ # noqa: E501
    application_number_text: Optional[StrictStr] = Field(default=None, alias="applicationNumberText")
    official_date: Optional[StrictStr] = Field(default=None, alias="officialDate")
    document_identifier: Optional[StrictStr] = Field(default=None, alias="documentIdentifier")
    document_code: Optional[StrictStr] = Field(default=None, alias="documentCode")
    document_code_description_text: Optional[StrictStr] = Field(default=None, alias="documentCodeDescriptionText")
    document_direction_category: Optional[StrictStr] = Field(default=None, alias="documentDirectionCategory")
    download_option_bag: Optional[List[DocumentBagDocumentBagInnerDownloadOptionBagInner]] = Field(default=None, alias="downloadOptionBag")
    __properties: ClassVar[List[str]] = ["applicationNumberText", "officialDate", "documentIdentifier", "documentCode", "documentCodeDescriptionText", "documentDirectionCategory", "downloadOptionBag"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in download_option_bag (list)
        _items = []
        if self.download_option_bag:
            for _item_download_option_bag in self.download_option_bag:
                if _item_download_option_bag:
                    _items.append(_item_download_option_bag.to_dict())
            _dict['downloadOptionBag'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "officialDate": obj.get("officialDate"),
            "documentIdentifier": obj.get("documentIdentifier"),
            "documentCode": obj.get("documentCode"),
            "documentCodeDescriptionText": obj.get("documentCodeDescriptionText"),
            "documentDirectionCategory": obj.get("documentDirectionCategory"),
            "downloadOptionBag": [DocumentBagDocumentBagInnerDownloadOptionBagInner.from_dict(_item) for _item in obj["downloadOptionBag"]] if obj.get("downloadOptionBag") is not None else None
        })
        return _obj
