...
class ApiV1PatentApplicationsApplicationNumberTextForeignPriorityGet200Response(BaseModel):
    """
    ApiV1PatentApplicationsApplicationNumberTextForeignPriorityGet200Response
    """ # noqa: E501
    count: Optional[StrictInt] = None
    patent_file_wrapper_data_bag: Optional[List[ApiV1PatentApplicationsApplicationNumberTextForeignPriorityGet200ResponsePatentFileWrapperDataBagInner]] = Field(default=None, alias="patentFileWrapperDataBag")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "patentFileWrapperDataBag": [ApiV1PatentApplicationsApplicationNumberTextForeignPriorityGet200ResponsePatentFileWrapperDataBagInner.from_dict(_item) for _item in obj["patentFileWrapperDataBag"]] if obj.get("patentFileWrapperDataBag") is not None else None
        })
        return _obj
