...
class PetitionDecisionIdentifierResponseBag(BaseModel):
    """
    PetitionDecisionIdentifierResponseBag
    """ # noqa: E501
    count: Optional[StrictInt] = None
    petition_decision_data_bag: Optional[List[PetitionDecisionAndDocuments]] = Field(default=None, alias="petitionDecisionDataBag")
    __properties: ClassVar[List[str]] = ["count", "petitionDecisionDataBag"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "petitionDecisionDataBag": [PetitionDecisionAndDocuments.from_dict(_item) for _item in obj["petitionDecisionDataBag"]] if obj.get("petitionDecisionDataBag") is not None else None
        })
        return _obj
