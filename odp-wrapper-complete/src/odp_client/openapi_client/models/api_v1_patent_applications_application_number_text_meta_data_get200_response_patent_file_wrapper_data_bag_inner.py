...
class ApiV1PatentApplicationsApplicationNumberTextMetaDataGet200ResponsePatentFileWrapperDataBagInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["applicationNumberText", "applicationMetaData"]
