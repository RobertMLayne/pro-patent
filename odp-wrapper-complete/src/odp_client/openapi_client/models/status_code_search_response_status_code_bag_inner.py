...
class StatusCodeSearchResponseStatusCodeBagInner(BaseModel):
    """
    StatusCodeSearchResponseStatusCodeBagInner
    """ # noqa: E501
    application_status_code: Optional[StrictInt] = Field(default=None, description="Application status code", alias="applicationStatusCode")
    application_status_description_text: Optional[StrictStr] = Field(default=None, description="Application status code description", alias="applicationStatusDescriptionText")
    __properties: ClassVar[List[str]] = ["applicationStatusCode", "applicationStatusDescriptionText"]
