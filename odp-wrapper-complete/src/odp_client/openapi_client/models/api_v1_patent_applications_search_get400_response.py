...
class ApiV1PatentApplicationsSearchGet400Response(BaseModel):
    """
    ApiV1PatentApplicationsSearchGet400Response
    """ # noqa: E501
    code: Optional[Any] = None
    error: Optional[Any] = None
    error_details: Optional[Any] = Field(default=None, alias="errorDetails")
    request_identifier: Optional[Any] = Field(default=None, alias="requestIdentifier")
    __properties: ClassVar[List[str]] = ["code", "error", "errorDetails", "requestIdentifier"]
