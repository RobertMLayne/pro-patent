...
class ForeignPriority(BaseModel):
    ...
    ForeignPriority
    """ # noqa: E501
    ip_office_name: Optional[StrictStr] = Field(default=None, alias="ipOfficeName")
    filing_date: Optional[StrictStr] = Field(default=None, alias="filingDate")
    application_number_text: Optional[StrictStr] = Field(default=None, alias="applicationNumberText")
    __properties: ClassVar[List[str]] = ["ipOfficeName", "filingDate", "applicationNumberText"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ipOfficeName": obj.get("ipOfficeName"),
