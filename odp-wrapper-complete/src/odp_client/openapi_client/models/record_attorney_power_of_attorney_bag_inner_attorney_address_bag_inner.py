...
class RecordAttorneyPowerOfAttorneyBagInnerAttorneyAddressBagInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["nameLineOneText", "nameLineTwoText", "addressLineOneText", "addressLineTwoText", "geographicRegionName", "geographicRegionCode", "postalCode", "cityName", "countryCode", "countryName"]
