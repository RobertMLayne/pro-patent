...
class ApplicationMetaDataInventorBagInner(BaseModel):
    """
    ...
    inventor_name_text: Optional[StrictStr] = Field(default=None, alias="inventorNameText")
    correspondence_address_bag: Optional[List[ApplicationMetaDataInventorBagInnerCorrespondenceAddressBagInner]] = Field(default=None, alias="correspondenceAddressBag")
    __properties: ClassVar[List[str]] = ["firstName", "middleName", "lastName", "namePrefix", "nameSuffix", "preferredName", "countryCode", "inventorNameText", "correspondenceAddressBag"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "inventorNameText": obj.get("inventorNameText"),
            "correspondenceAddressBag": [ApplicationMetaDataInventorBagInnerCorrespondenceAddressBagInner.from_dict(_item) for _item in obj["correspondenceAddressBag"]] if obj.get("correspondenceAddressBag") is not None else None
        })
        return _obj
