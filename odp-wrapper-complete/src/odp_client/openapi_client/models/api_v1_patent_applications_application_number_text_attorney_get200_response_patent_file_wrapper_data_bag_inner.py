...
class ApiV1PatentApplicationsApplicationNumberTextAttorneyGet200ResponsePatentFileWrapperDataBagInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["applicationNumberText", "recordAttorney"]
