...
class PetitionDecisionRange(BaseModel):
    """
    ...
    value_from: Optional[StrictStr] = Field(default=None, alias="valueFrom")
    value_to: Optional[StrictStr] = Field(default=None, alias="valueTo")
    __properties: ClassVar[List[str]] = ["field", "valueFrom", "valueTo"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "field": obj.get("field"),
            "valueFrom": obj.get("valueFrom"),
            "valueTo": obj.get("valueTo")
        })
        return _obj
