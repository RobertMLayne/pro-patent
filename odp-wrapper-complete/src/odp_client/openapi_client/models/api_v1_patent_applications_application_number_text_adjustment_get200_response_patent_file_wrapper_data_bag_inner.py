...
class ApiV1PatentApplicationsApplicationNumberTextAdjustmentGet200ResponsePatentFileWrapperDataBagInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["applicationNumberText", "patentTermAdjustmentData"]
