...
class PatentDataResponse(BaseModel):
    ...
    patent_file_wrapper_data_bag: Optional[List[PatentDataResponsePatentFileWrapperDataBagInner]] = Field(default=None, alias="patentFileWrapperDataBag")
    facets: Optional[List[PatentDataResponseFacetsInner]] = None
    __properties: ClassVar[List[str]] = ["count", "patentFileWrapperDataBag", "facets"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "patentFileWrapperDataBag": [PatentDataResponsePatentFileWrapperDataBagInner.from_dict(_item) for _item in obj["patentFileWrapperDataBag"]] if obj.get("patentFileWrapperDataBag") is not None else None,
            "facets": [PatentDataResponseFacetsInner.from_dict(_item) for _item in obj["facets"]] if obj.get("facets") is not None else None
        })
        return _obj
