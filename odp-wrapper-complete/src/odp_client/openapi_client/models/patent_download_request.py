...
class PatentDownloadRequest(BaseModel):
    ...
    range_filters: Optional[List[Range]] = Field(default=None, alias="rangeFilters")
    sort: Optional[List[Sort]] = None
    fields: Optional[List[StrictStr]] = None
    pagination: Optional[Pagination] = None
    format: Optional[StrictStr] = Field(default=None, description="Download format. csv or json")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rangeFilters": [Range.from_dict(_item) for _item in obj["rangeFilters"]] if obj.get("rangeFilters") is not None else None,
