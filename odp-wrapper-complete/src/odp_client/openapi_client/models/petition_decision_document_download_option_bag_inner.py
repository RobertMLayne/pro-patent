...
class PetitionDecisionDocumentDownloadOptionBagInner(BaseModel):
    """
    PetitionDecisionDocumentDownloadOptionBagInner
    """ # noqa: E501
    mime_type_identifier: Optional[StrictStr] = Field(default=None, alias="mimeTypeIdentifier")
    document_uri: Optional[StrictStr] = Field(default=None, alias="documentURI")
    page_total_quantity: Optional[StrictInt] = Field(default=None, alias="pageTotalQuantity")
    __properties: ClassVar[List[str]] = ["mimeTypeIdentifier", "documentURI", "pageTotalQuantity"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "mimeTypeIdentifier": obj.get("mimeTypeIdentifier"),
            "documentURI": obj.get("documentURI"),
