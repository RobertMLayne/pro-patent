...
class RecordAttorneyPowerOfAttorneyBagInner(BaseModel):
    """
    ...
    active_indicator: Optional[StrictStr] = Field(default=None, alias="activeIndicator")
    registered_practitioner_category: Optional[StrictStr] = Field(default=None, alias="registeredPractitionerCategory")
    attorney_address_bag: Optional[List[RecordAttorneyPowerOfAttorneyBagInnerAttorneyAddressBagInner]] = Field(default=None, alias="attorneyAddressBag")
    telecommunication_address_bag: Optional[List[RecordAttorneyPowerOfAttorneyBagInnerTelecommunicationAddressBagInner]] = Field(default=None, alias="telecommunicationAddressBag")
    __properties: ClassVar[List[str]] = ["firstName", "middleName", "lastName", "namePrefix", "nameSuffix", "preferredName", "countryCode", "registrationNumber", "activeIndicator", "registeredPractitionerCategory", "attorneyAddressBag", "telecommunicationAddressBag"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in attorney_address_bag (list)
        _items = []
        if self.attorney_address_bag:
            for _item_attorney_address_bag in self.attorney_address_bag:
                if _item_attorney_address_bag:
                    _items.append(_item_attorney_address_bag.to_dict())
            _dict['attorneyAddressBag'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "activeIndicator": obj.get("activeIndicator"),
            "registeredPractitionerCategory": obj.get("registeredPractitionerCategory"),
            "attorneyAddressBag": [RecordAttorneyPowerOfAttorneyBagInnerAttorneyAddressBagInner.from_dict(_item) for _item in obj["attorneyAddressBag"]] if obj.get("attorneyAddressBag") is not None else None,
            "telecommunicationAddressBag": [RecordAttorneyPowerOfAttorneyBagInnerTelecommunicationAddressBagInner.from_dict(_item) for _item in obj["telecommunicationAddressBag"]] if obj.get("telecommunicationAddressBag") is not None else None
        })
        return _obj
