...
class RecordAttorneyCustomerNumberCorrespondenceDataInnerTelecommunicationAddressBagInner(BaseModel):
    """
    RecordAttorneyCustomerNumberCorrespondenceDataInnerTelecommunicationAddressBagInner
    """ # noqa: E501
    telecommunication_number: Optional[StrictStr] = Field(default=None, alias="telecommunicationNumber")
    extension_number: Optional[StrictStr] = Field(default=None, alias="extensionNumber")
    telecom_type_code: Optional[StrictStr] = Field(default=None, alias="telecomTypeCode")
    __properties: ClassVar[List[str]] = ["telecommunicationNumber", "extensionNumber", "telecomTypeCode"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "telecommunicationNumber": obj.get("telecommunicationNumber"),
            "extensionNumber": obj.get("extensionNumber"),
            "telecomTypeCode": obj.get("telecomTypeCode")
        })
        return _obj
