...
class ApiV1PatentApplicationsApplicationNumberTextAssignmentGet200ResponsePatentFileWrapperDataBagInner(BaseModel):
    """
    ...
    assignment_bag: Optional[Assignment] = Field(default=None, alias="assignmentBag")
    __properties: ClassVar[List[str]] = ["applicationNumberText", "assignmentBag"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of assignment_bag
        if self.assignment_bag:
            _dict['assignmentBag'] = self.assignment_bag.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "assignmentBag": Assignment.from_dict(obj["assignmentBag"]) if obj.get("assignmentBag") is not None else None
        })
        return _obj
