...
class ApiV1PatentApplicationsApplicationNumberTextForeignPriorityGet200ResponsePatentFileWrapperDataBagInner(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["applicationNumberText", "foreignPriorityBag"]
